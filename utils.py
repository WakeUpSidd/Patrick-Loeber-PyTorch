...
# Turn a line into <line_length x 1 x n_letters> , or an array of one-hot letter vectors
...
if __name__ == '__main__':
    ...
    print(category_lines['Italian'][:5])  # Country as Key, and corresponding names as values.
